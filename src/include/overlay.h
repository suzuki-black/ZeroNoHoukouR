...
#define OVL7_BANK               28
#define OVL_SLOT_CLOUD_FRAME    21   /* 通常面のオーバレイ(1〜5面の雲)。最終面/撃沈のオーバレイでは 0 を返す空関数 */
...
u8   cloud_frame(u8 slot, u8 spawn);       /* 1〜5面の雲: slot から雲のスプライトを置き、使った枚数を返す。spawn=0 で新しい雲を出さない */
