...
/* ★パワーアップの太い弾(3ドット幅、どれも 4〜11 行に収めて色表の段を共通にする)。左上/右上は傾き 3:5(速度 ±3,-5 に合わせる) */
static const u8 pat_pwv[32] = {
    0x00,0x00,0x00,0x00,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x00,0x00,0x00,0x00
};
static const u8 pat_pwl[32] = {
    0x00,0x00,0x00,0x00,0x0E,0x07,0x07,0x03,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0xC0,0xC0,0xE0,0xE0,0x00,0x00,0x00,0x00
};
static const u8 pat_pwr[32] = {
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x03,0x03,0x07,0x07,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x70,0xE0,0xE0,0xC0,0x80,0x80,0x00,0x00,0x00,0x00,0x00,0x00
};
/* 増槽(涙型の落下タンク＋小さな尾翼)。色は行ごとの色表(scene_stage の tank_col) */
static const u8 pat_tank[32] = {
    0x00,0x03,0x07,0x0F,0x0F,0x0F,0x0F,0x0F,0x0F,0x07,0x07,0x03,0x03,0x06,0x0C,0x00,0x00,0xC0,0xE0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xE0,0xE0,0xC0,0xC0,0x60,0x30,0x00
};
...
static void load_sprites_impl(void) {
    ...
    vdp_sprite_pattern(SPR_PWL,      pat_pwl);
    vdp_sprite_pattern(SPR_PWR,      pat_pwr);
    vdp_sprite_pattern(SPR_TANK,     pat_tank);   /* ★停泊機(空母)は今まで通り手描きF6F。空戦戦闘機は8方向生成へ移行 */
