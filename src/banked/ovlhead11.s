;; ovlhead11.s — 3面の中ボス(駆逐艦)用 RAM オーバレイ(OVL11_BANK)の先頭ジャンプテーブル。ovlhead8.s と同じ並びで、
;; slot14(衝撃波の分割表)だけ ovl_dd_split(艦の帯の横ずれと荒天のうねり)へ差し替える。
